...
# wharfer build -t sam-sample-project . && wharfer run -it -p 5000:5000 -v /nfs/students/example-project/input:/example-project/input:ro -v /nfs/students/example-project/output:/example-project/output:rw sam-sample-project
